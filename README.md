...
Outra dificuldade foi que durante o desenvolvimento a configuração do ambiente para gerar o arquivo `fs.bin`. Foi necessário utilizar o Docker para preparar o ambiente e gerar o arquivo usado na simulação. Houve também uma dificuldade inicial para entender como o `diagram.json` funciona e como os componentes e pinos precisam ser configurados para que o Wokwi consiga interagir corretamente com o projeto.
